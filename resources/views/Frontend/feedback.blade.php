        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <form method="POST" id='requestLogin' action="{{route('login.signin')}}">
                ...
                <button type="submit" class="btn btn-success" style='margin-top: 10px' id='btnLogin' type='submit'>LOGIN</button>
              </form>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            @endif
              ...
              <button type="submit" class="btn btn-success" id='btnSignup'>REGISTRATION</button>
          </div>
          </form>
          <div class="modal-footer">
            <button data-dismiss='modal' class="btn-danger">Close</button>
