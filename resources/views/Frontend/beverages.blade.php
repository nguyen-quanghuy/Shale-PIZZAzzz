...
<ul>
          ...
          <li class="nav-item" id= "pizzaitem"><a class="nav-link active1" href="{{route('beverages')}}" target="_self" style="color: white">BEVERAGES</a></li>
      </ul>
  </div><br>
            <div class="clearfix">
              <h2 style="text-align: center; color: white; font-weight: bold;margin-top: 25px">BEST BEVERAGES 2020</h2>


              <div class="container">
                <div class="menu-header" >
                  <h3 style="margin-bottom: 0px">FAVORITE</h3>
                  <a href="#Beverage" style="margin-left: 980px; text-decoration: none">Have {{count($menuBeverage)}} products</a>
                 </div><br>
               <div class="row">
                 ...
                 <!-- <div class="col-sm-4 h-75">
                   <div class="panel text-center" id="item" style="color: white">
                        <img class="img-round" style="width: 100%;" src="img-douong/2.jpg" >
                          <div class="panel-body">
                          <h5 style="margin-top: 30px">HOT MILK </h5>
                 ...
                 <div class="col-sm-4 h-75">
                   <div class="panel text-center" id="item" style="color: white">
                        <img class="img-round" style="width: 100%;" src="img-douong/3.jpg" >
                          <div class="panel-body">
                          <h5 style="margin-top: 30px">LEMON CARLOTA</h5>
              ...
              <!-- <div class="row">
                 <div class="col-sm-4 h-75">
                   <div class="panel text-center" id="item" style="color: white;">
                        <img class="img-round" style="width: 100%;" src="img-douong/4.jpg" >
                          <div class="panel-body">
                          <h5 style="margin-top: 30px">CAPUCHINO</h5>
                 ...
                 <div class="col-sm-4 h-75">
                   <div class="panel text-center" id="item"  style="color: white">
                        <img class="img-round" style="width: 100%;" src="img-douong/5.jpg" >
                          <div class="panel-body">
                          <h5 style="margin-top: 30px">BLACK COFFEE</h5>
                 ...
                 <div class="col-sm-4 h-75">
                   <div class="panel text-center" id="item" style="color: white">
                        <img class="img-round" style="width: 100%;" src="img-douong/6.jpg" >
                          <div class="panel-body">
                          <h5 style="margin-top: 30px">MILK COFFEE</h5>
                          <p style="font-size: 30px">1.5$</p>
                          </div>
                       <div class="panel-footer">
                       <button type="button" id="addcart" class="btn btn-primary"  data-toggle="modal" data-target="#myModal3"><span class="glyphicon glyphicon-shopping-cart"><img src="css/cart.png" style="width: 30px"></span>&ensp;ADD TO CART</button>
