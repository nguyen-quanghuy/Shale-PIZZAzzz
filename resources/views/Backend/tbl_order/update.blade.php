                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{route('update_order', $edit_order->id)}}" method='POST'>
                            ...
                            <table >
                                <tr>
                                    <td>ID</td>
                                    <td><input type="number" value="{{$edit_order->id}}" name='nbrId' placeholder="Enter ID" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>Date Create</td>
                                    <td><input type="datetime-local" value="{{$edit_order->date_create}}" name='txtDate' placeholder="Enter Date create" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>User ID</td>
                                    <td><input type="number" value="{{$edit_order->user_id}}" name='txtUserId' class="form-control" placeholder="Enter User ID"></td>
                                </tr>
                                <tr>
                                    <td>Status</td>
