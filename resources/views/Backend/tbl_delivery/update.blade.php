                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{route('update_delivery', $edit_delivery->id)}}" method='POST'>
                            ...
                            <table >
                                ...
                                <tr>
                                    <td>Customer Id</td>
                                    <td><input type="number" value='{{$edit_delivery->customer_id}}' name='nbrCusId' placeholder="Enter Customer Id" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td>Phone Numbers</td>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type='submit' class="btn btn-success w-100" value='Add New ID' style="color: white"></td>
                                </tr>
                            </table>
                        </form>
                    </div>
