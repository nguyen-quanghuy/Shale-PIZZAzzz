...
<body>
	<nav class="navbar bg-dark sticky-top">
	    <a href="#" class="navbar-brand" >
			<img src="{{asset('style/logo.png')}}" width="90px" style="display: inline-block;"><h4 style="display: inline-block;color: white">Shale-Pizza</h4>
		</a>
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="profile">
				<a href="#">
        <img src="{{asset('Img/admin.png')}}" class="rounded-circle img-fluid" width="70">
