...
class ProductController extends Controller
{
    ...
    public function getProductPizza(){
        $menuPizza = tbl_product::where('menu', 'pizza')->paginate(3);
        $menuPreminum = tbl_product::where('menu', 'preminum')->paginate(3);
    ...
    public function getProductDessert(){
        $menuDessert = tbl_product::where('menu', 'desserts')->paginate(3);
        return view('Frontend.dessert', compact('menuDessert'));
    }
    public function getProductBeverage(){
        $menuBeverage = tbl_product::where('menu', 'beverages')->paginate(3);
        return view('Frontend.beverages', compact('menuBeverage'));
    }
    public function getProductSandwiches(){
        $menuSandwiches = tbl_product::where('menu', 'pizza sandwiches')->paginate(3);
